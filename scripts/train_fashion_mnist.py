...
from load_fashion_mnist import load_small_fashion_mnist, load_fashion_mnist
...
model = All_CNN_C(
    ...
    train_dir='output',
    log_dir='log',
    model_name='fashion_mnist_small_all_cnn_c')
...
np.savez(
    'output/fashion_mnist_small_all_cnn_c_iter-500k_retraining-100.npz',
